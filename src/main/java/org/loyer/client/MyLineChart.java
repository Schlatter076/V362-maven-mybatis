...
public class MyLineChart {
  ...
  public MyLineChart(List<V362Recordtd> list) {
  ...
  public DefaultCategoryDataset getDataSet(List<V362Recordtd> list) {
    DefaultCategoryDataset set = new DefaultCategoryDataset();
    for (V362Recordtd data : list) {
  ...
  public static void saveAsJPEG() {
    MyLineChart lineChart = new MyLineChart(new V362RecordtdImpl().getAll());
    try {
      String path = "excl/";
      ...
      // 创建可写入的Excel工作簿
      String fileName = "v362不良记录" + LocalDate.now() + ".png";
